...
INITIAL_MESSAGE = "Assistant: I am your {model_str} rephrasing expert! provide me with a sentence and an application and" \
...
def run_app(model_str: str, api_key: str, comm: MPI.Comm, sender: int) -> None:
    ...
    while True:
        ...
        # change the {app} and {sentence} in the prompt template to the actual values of the app and sentence
        ...
        print(f"rephrased sentence: {rephrased_sentence}", flush=True)
        print("-" * 79)
